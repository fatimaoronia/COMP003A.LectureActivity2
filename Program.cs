 ...
 * Course: COMP-003A
 * Purpose: Lecture activity first variables, type system, Math, and Console Properties
...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        // score = "Generic User"; // will fail to complete because you are assigning a string value to an integer variable
        ...
        /* reading from a variable does not chnage it */
        int a;
        int b;
        ...
        string exampleVAriable;
        string examapleVARiable;

        Console.WriteLine("**************************************************");
        /*
         * types of variables and values matter in C#. they are not interchangable.
         * there are eight integer types for storing integers of differing sizes and ranges: int, long, byte, sbyte, uint, ushort, and ulong.
         ...
         * using var for a variable's type tells the compiler to infer its type from the surrouding code, so you do not have to type it out. (But it still has a specific type.)
        ...
        Console.WriteLine($"Concatenation using string interpolation : {aLetter}{message}"); // use string interpolation with a dollar-sign ($) before theopening double-quote and enclosing variables with curly braces({ variableName})
...
*/
        ...
        */
        ...
        compoundAssignmentOperator /= 2; // The equivalent of compoundAssignmentOperator = compoundAssignmentOperator / 2; (a is 6 after this line runs.)\ compoundAssignmentOperator %= 2; // The equivalent of compoundAssignmentOperator = compoundAssignmentOperator % 2; (a is 0 after this line runs.)
